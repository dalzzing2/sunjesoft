...
DROP VIEW IF EXISTS PERFORMANCE_VIEW_SCHEMA.TECH_CLUSTER_INDEX;

CREATE VIEW PERFORMANCE_VIEW_SCHEMA.TECH_CLUSTER_INDEX
(
  OWNER,
  TAB_SCHEMA,
  TAB_NAME,
...
GRANT SELECT ON TABLE PERFORMANCE_VIEW_SCHEMA.TECH_CLUSTER_INDEX TO PUBLIC;